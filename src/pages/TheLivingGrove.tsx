      ...
      <main className="relative z-10 pt-24 pb-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <h1 
              className="text-4xl md:text-6xl lg:text-7xl font-display font-medium tracking-wider mb-6"
              style={{
          ...
          >
            <div 
              className="relative p-8 md:p-12 rounded-2xl border border-border/50 backdrop-blur-sm"
              style={{
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  />
                  <feature.icon className="w-10 h-10 mb-4 text-primary" style={{ color: 'hsl(160 70% 50%)' }} />
                ...
                {phases.map((phase, index) => (
                  ...
                  >
                    ...
                    <div 
                      ...
                      style={{
                        borderColor: phase.status === 'in-progress' 
                          ? 'hsl(160 70% 50%)' 
                    ...
                    <div className="p-5 rounded-lg border border-border/40 bg-card/20 backdrop-blur-sm">
                      <div className="flex items-center gap-3 mb-2">
                        <span 
                          className="text-xs tracking-wider uppercase font-body px-2 py-1 rounded"
                          style={{
                            background: phase.status === 'in-progress' 
                              ? 'hsl(160 70% 50% / 0.2)' 
                              : 'hsl(200 20% 40% / 0.1)',
                            color: phase.status === 'in-progress' 
                              ? 'hsl(160 70% 60%)' 
                              : 'hsl(200 20% 60%)',
                          }}
                        >
                        ...
                        {phase.status === 'in-progress' && (
                          <span className="text-xs text-green-400 font-body animate-pulse">
                            Currently Active
                          </span>
                        )}
                      </div>
          ...
          >
            <div 
              className="p-8 md:p-12 rounded-2xl border border-border/50 backdrop-blur-sm"
              style={{
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link 
                  to="/offering"
                  className="px-8 py-3 rounded-lg font-display tracking-wider transition-all duration-300 hover:scale-105"
                  style={{
                ...
                <Link 
                  to="/csc"
                  className="px-8 py-3 rounded-lg font-display tracking-wider border border-border/50 text-foreground hover:border-primary/50 transition-all duration-300"
                  style={{
