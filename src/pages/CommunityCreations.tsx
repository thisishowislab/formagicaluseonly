        ...
        <div className="max-w-4xl mx-auto">
              ...
              {exchangeTypes.map((type, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-display font-medium text-foreground mb-2" style={{ color: type.color }}>
                        {type.title}
                      </h3>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
              {[
                { step: '01', text: 'Find a CSC-eligible item' },
                { step: '02', text: 'Reach out via email' },
                { step: '03', text: 'We discuss exchange options' },
                { step: '04', text: 'Agree & create together' },
              ].map((item, index) => (
          ...
          >
            <div className="inline-flex items-center gap-3 px-8 py-4 rounded-lg border border-accent/30 bg-accent/5">
              ...
              <p className="text-foreground font-body">
                Ready to explore?{' '}
                <a 
                  href="mailto:hello@manifestorium.com?subject=CSC Inquiry"
